...
const validateTeam = [
    ...
    body('bio')
        ...
        .trim()
        .isLength({ max: 2000 })
        .withMessage('Biyografi maksimum 2000 karakter olabilir'),
    body('imageUrl')
        .optional()
        .trim()
        .isURL()
...
const validateBasicContent = [
    ...
    body('content')
        ...
        .trim()
        .isLength({ max: 10000 })
        .withMessage('İçerik maksimum 10000 karakter olabilir'),
    body('description')
        .optional()
        .trim()
        .isLength({ max: 1000 })
    ...
    body('category')
        .optional()
        .isIn(['education', 'surgery', 'research', 'patient', 'conference', 'treatment', 'recovery', 'appointment',
            'general', 'technology', 'pharmaceutical', 'equipment', 'support', 'ongoing', 'completed', 'planned',
            "medical", "pharmaceutical", "equipment", "research", "other", "healthcare"])
